        ...
        <div class="card shadow-sm border-0">
            <div class="card-header bg-white border-bottom py-3">
                <h5 class="mb-0 font-weight-bold">
                    <i class="fas fa-user-edit mr-2 text-warning"></i>Update Teacher Details
                </h5>
                <p class="text-muted small mb-0">Modify the information for <strong>{{ $teacher->name }}</strong>.</p>
            </div>
                ...
                <form action="{{ url('teachers/' .$teacher->id) }}" method="post">
                    ...
                    <div class="form-group mb-4">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" name="name" id="name" value="{{$teacher->name}}" class="form-control border-left-0 pl-0" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group mb-4">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" name="address" id="address" value="{{$teacher->address}}" class="form-control border-left-0 pl-0" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group mb-4">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" name="mobile" id="mobile" value="{{$teacher->mobile}}" class="form-control border-left-0 pl-0" required>
                        </div>
                    </div>
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <button type="submit" class="btn btn-warning text-white px-5 shadow-sm font-weight-bold">
                            Update Teacher <i class="fas fa-sync-alt ml-2"></i>
                        </button>
                    </div>
                </form>
            </div>
...
<style>
    /* Styling for custom labels and focus states */
    .font-weight-600 { font-weight: 600; color: #334155; margin-bottom: 8px; display: inline-block; }
    .form-control:focus {
        border-color: #f59e0b; /* Matches the Warning/Update theme color */
